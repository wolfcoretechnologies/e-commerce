                        ...
                        <nav class="grid__item" id="AccessibleNav"><!-- for mobile -->
                                    ...
                                    <div class="megamenu style4">
                                        <ul class="grid grid--uniform mmWrapper">
                                            ...
                                            <li class="grid__item lvl-1 col-md-6 col-lg-6">
                                                <a href="#"><img src="assets/images/home-images/hm-28.jpg" alt=""
                                                        title="" /></a>
                                            </li>
                                        </ul>
                                    </div>
                          ...
                          <ul class="dropdown">
                            ...
                            <li><a href="blog-article.html" class="site-nav">Article</a></li>
                                ...
                                <li class="lvl1"><a href="#" class="
glow-on-hover "><b>Buy Now!</b> <i class="anm anm-angle-down-l"></i></a></li>
                            </ul>
                        </nav>
                        <!--End Desktop Menu-->
                    </div>
                                ...
                                <ul class="mini-products-list">
                                    <li class="item">
                                        <a class="product-image" href="#">
                                            <img src="assets/images/home-images/hm-23.jpg" alt="3/4 Sleeve Kimono Dress"
                                                title="" />
                                        </a>
                                    ...
                                    <li class="item">
                                        <a class="product-image" href="#">
                                            <img src="assets/images/home-images/hm-20.jpg"
                    ...
                    <div class="collection-grid">
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/home-images/hm-6.jpg"
                                    src="assets/images/home-images/hm-6.jpg" alt="Fashion" class="lazyload" />
                        ...
                        <div class="collection-grid-item lazyloaded">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/home-images/hm-3.jpg"
                                    src="assets/images/home-images/hm-7.jpg" alt="Bag" class=" lazyload" />
                                <!-- <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/home-images/hm-9.jpg"
                                    src="assets/images/home-images/hm-9.jpg" alt="Shoes" class=" lazyload" />
                                <!-- <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/home-images/hm-8.jpg"
                                    src="assets/images/home-images/hm-8.jpg" alt="Jewellry" class=" lazyload" />
                                <!-- <div class="collection-grid-item__title-wrapper">
                        ...
                        <div class="collection-grid-item">
                            <a href="collection-page.html" class="collection-grid-item__link">
                                <img data-src="assets/images/home-images/hm-27.jpg"
                                    src="assets/images/home-images/hm-6.jpg" alt="Fashion" class=" lazyload" />
                                <!-- <div class="collection-grid-item__title-wrapper">
                                    <h3 class="collection-grid-item__title btn btn--secondary no-border">Fashion</h3>
                                </div> -->
