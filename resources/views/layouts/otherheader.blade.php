                                    ...
                                    <li class="grid__item large-up--one-whole">
                                        <ul class="grid">
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                                    class="site-nav lvl-1">Home Group
                                                    1</a>
                                                <ul class="subLinks">
                                            ...
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                                ...
                                                <ul class="subLinks">
                                                    ...
                                                    <li class="lvl-2"><a href="home5-cosmetic.html"
                                                            ...
                                                            Product</a></li>
                                                    <li class="lvl-2"><a href="home7-shoes.html"
                                                            class="site-nav lvl-2">Columns with Items</a>
                                                    </li>
                                                    <li class="lvl-2"><a href="home6-modern.html"
                                            ...
                                            <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                                ...
                                                <ul class="subLinks">
                                                    <li class="lvl-2"><a href="home13-auto-parts.html"
                                                            ...
                                                            Bar <span class="lbl nm_label1">New</span></a></li>
                            ...
                            <div class="megamenu style4">
                                <ul class="grid grid--uniform mmWrapper">
                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                        ...
                                        <ul class="subLinks">
                                            <li class="lvl-2"><a href="shop-left-sidebar.html"
                                                    class="site-nav lvl-2">Left Sidebar</a>
                                            </li>
                                            <li class="lvl-2"><a href="shop-right-sidebar.html"
                                                    class="site-nav lvl-2">Right Sidebar</a>
                                            </li>
                                    ...
                                    <li class="grid__item lvl-1 col-md-3 col-lg-3"><a href="#"
                                        ...
                                        <ul class="subLinks">
                                            <li class="lvl-2"><a href="shop-left-sidebar.html"
                                                    class="site-nav lvl-2">Product Countdown
                                            ...
                                            <li class="lvl-2"><a href="shop-grid-6.html"
                                                    class="site-nav lvl-2">Pagination - Load More</a>
                                            </li>
                                            ...
                                            <li class="lvl-2"><a href="product-swatches-style.html"
                                                    ...
                                                    Swatches <span class="lbl nm_label2">Sale</span></a></li>
                                            <li class="lvl-2"><a href="product-hover-info.html"
                                                    class="site-nav lvl-2">Product Hover
                                                    Info</a></li>
                        ...
                        <ul class="mini-products-list">
                            <li class="item">
                                <a class="product-image" href="#">
                                    <img src="{{ asset('assets/images/home-images/hm-19.jpg') }}" alt="3/4 Sleeve Kimono Dress"
                                        title="" />
                                </a>
                            ...
                            <li class="item">
                                <a class="product-image" href="#">
                                    <img src="{{ asset('assets/images/home-images/hm-19.jpg') }}"
